...
scoreboard objectives add lightium.trigger.parrainage trigger
...
team add lightium.parraine {"text":"Parrainé","color":"light_purple"}
...
team modify lightium.parraine prefix {"text":"[Parrainé] ","color":"light_purple","italic":true}
...
team modify lightium.parraine collisionRule never
