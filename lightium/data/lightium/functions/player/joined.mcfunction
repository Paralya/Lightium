...
execute if score #success lightium.data matches 0 store success score #success lightium.data if score @s lightium.timestamp matches 1593468000..1593468500 run tellraw @s ["",{"nbt":"Paralya","storage":"lightium:main","interpret":true},{"text":" Dernière connexion il y a plus de "},{"score":{"name":"#year","objective":"lightium.data"}},{"text":" ans, "},{"score":{"name":"#month","objective":"lightium.data"}},{"text":" mois, "},{"score":{"name":"#day","objective":"lightium.data"}},{"text":" jour(s), "},{"score":{"name":"#hour","objective":"lightium.data"}},{"text":" heure(s), "},{"score":{"name":"#minute","objective":"lightium.data"}},{"text":" minute(s) et "},{"score":{"name":"#second","objective":"lightium.data"}},{"text":" seconde(s).\nEn bref, il y a "},{"score":{"name":"#time","objective":"lightium.data"}},{"text":" secondes !"}]
