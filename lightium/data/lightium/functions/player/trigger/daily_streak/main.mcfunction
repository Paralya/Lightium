...
execute if score #success lightium.data matches 0 store success score #success lightium.data if entity @s[team=lightium.lumiere,tag=!lightium.daily_double]
