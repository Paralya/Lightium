...
execute if score #error lightium.data matches 2 run tellraw @s [{"nbt":"ParalyaError","storage":"lightium:main","interpret":true},{"text":" Nan mais le mec il essaie de se remercier, mais on est où là ?!!!"}]
