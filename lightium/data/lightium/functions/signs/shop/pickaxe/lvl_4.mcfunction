...
data modify storage lightium:main Item set value '[{"text":"une ","color":"white"},{"text":"Pickaxe Lv.4","color":"gold"},{"text":" !"}]'
...
execute if score #success lightium.data matches 1 run data modify entity @e[type=item,sort=nearest,limit=1,nbt={Age:0s,Item:{tag:{simplenergy:{simplunium_pickaxe:1b}}}}] Item.tag.Enchantments set value [{id:"efficiency",lvl:5}]
