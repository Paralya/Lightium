...
summon villager 5 78 -9 {Tags:["lightium.villager","lightium.villager.utiles"],Rotation:[-90.0f,0.0f],NoGravity:1b,Invulnerable:1b,VillagerData:{level:99,profession:"toolsmith",type:"taiga"},Offers:{Recipes:[]}}
execute as @e[tag=lightium.villager.utiles] run function lightium:villagers/type/utiles

summon villager 9 78 -5 {Tags:["lightium.villager","lightium.villager.materiaux"],Rotation:[180.0f,0.0f],NoGravity:1b,Invulnerable:1b,VillagerData:{level:99,profession:"farmer",type:"taiga"},Offers:{Recipes:[]}}
execute as @e[tag=lightium.villager.materiaux] run function lightium:villagers/type/materiaux

summon villager 12 78 -11 {Tags:["lightium.villager","lightium.villager.energy_buy"],Rotation:[-90.0f,0.0f],NoGravity:1b,Invulnerable:1b,VillagerData:{level:99,profession:"librarian",type:"taiga"},Offers:{Recipes:[]}}
summon villager 12 78 -13 {Tags:["lightium.villager","lightium.villager.energy_sell"],Rotation:[-90.0f,0.0f],NoGravity:1b,Invulnerable:1b,VillagerData:{level:99,profession:"librarian",type:"taiga"},Offers:{Recipes:[]}}
